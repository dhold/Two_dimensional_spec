function [R1,R2,R3,R4,R5,R6,tmp_gg_t,tmp_ee_t] = rp_cont_HEOM2(sz_params,rho_eg,V_ge_t,V_ef_t,...
       ...
       % plot(t2_range,tmp_ee_t([1,4],:))
        ...
        for j3 = 1:N
          ...
          R3tmp = sparse(R3tmp);
            ...
            R_1 = mtimesx( V_ge_sec,'C',mtimesx(R1tmp,ori_fct_rf)); %t3_range by t2_range
            R_4 = mtimesx( V_ge_sec,'C',mtimesx(R4tmp,ori_fct_rf));
            ...
            R_2 =  mtimesx(V_ge_sec,'C',mtimesx(R2tmp,ori_fct_nr)); %t3_range by t2_range
            R_3 =  mtimesx(V_ge_sec,'C',mtimesx(R3tmp,ori_fct_nr));
            ...
            R6tmp2 = mtimesx( R6tmp,ori_fct_rp);
            R6tmp3 = mtimesx( V_ef_t(:,:,j4,f),'C',R6tmp2);
           ...
           R5tmp2 = mtimesx( V_ef_t(:,:,j4,f),'C',R5tmp);
