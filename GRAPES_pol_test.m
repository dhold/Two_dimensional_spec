...
e1min = double(subs(ee1,[cc,b],{minimum2(lp,1,3),b_range(lp)}));
e2min = double(subs(ee2,[cc,b],{minimum2(lp,2,3),b_range(lp)}));
e3min = double(subs(ee3,[cc,b],{minimum2(lp,3,:),b_range(lp)}));
e4min = double(subs(ee4,[cc,b],{minimum2(lp,4,:),b_range(lp)}));
